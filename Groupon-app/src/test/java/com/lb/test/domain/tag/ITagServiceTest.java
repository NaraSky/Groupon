package com.lb.test.domain.tag;

import com.lb.domain.tag.service.TagService;
...
public class ITagServiceTest {
    ...
    public void test_get_tag_bitmap() {
        ...
        // 是否存在
        log.info("xiaofuge 存在，预期结果为 true，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("userId1")));
        log.info("gudebai 不存在，预期结果为 false，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("userId4")));
    }
